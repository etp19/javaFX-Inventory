...
public class PartScreenController {
    ...
    void initializePart(Part part) {
        if (part == null) {
            ...
            this.inhousePart.setToggleGroup(this.partTypeGroup);
            this.outsourcedPart.setToggleGroup(this.partTypeGroup);
        } else {
            ...
            if (part instanceof InHousePart) {
                ...
                partMachineId.setText(Integer.toString(((InHousePart) part).getMachineId()));
            } else {
    ...
    void checkForPartType() {
        ...
        } else if (this.partTypeGroup.getSelectedToggle().equals(this.outsourcedPart)) {
